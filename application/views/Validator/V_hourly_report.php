      ...
      <div class="collapse navbar-collapse navbar-collapse-toolbar" id="site-navbar-collapse">
        ...
        <ul class="nav navbar-toolbar navbar-right navbar-toolbar-right">
           <li class="nav-item dropdown">
            <a href="<?php echo base_url().'Validator';?>" class="nav-link waves-effect waves-light waves-round">
          ...
          <div class="panel-body mt-10">
            <table class="table table-hover dataTable table-striped w-full" data-plugin="dataTable">
              ...
              <tbody>
                ...
                ?>
                <tr class='clickable-row' style="cursor: pointer;" data-href='<?php echo base_url().'Validator/update_data_radio/'.$no_unit.'/'.$id;?>'>
                  ...
                  <td>
                    <a href="<?php echo base_url().'Validator/update_data_radio/'.$no_unit.'/'.$id;?>" class="button mr-10" style="font-size:large; text-decoration:none !important;">
