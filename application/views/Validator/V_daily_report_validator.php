              ...
              <tbody>
                <?php
                  if(!empty($activity['unit'])){
                    for ($i=0; $i < count($activity['unit']); $i++) { 
                      $unit = $activity['unit'][$i];
                      $proses = $activity['proses'][$i];
                      $aktivitas = $activity['aktivitas'][$i];
                      $loading_point = $activity['loading_point'][$i];
                      $dumping_area = $activity['dumping_area'][$i];
                      $total_ritasi = $activity['total_ritasi'][$i];
                      $status = $activity['status'][$i];
                ?>
                <tr class='clickable-row' style="cursor: pointer;" data-href='<?php echo base_url().'Validator/detail_activity_validator/'.$unit;?>'>
                  <td><?php echo $unit;?></td>
                  <td><?php echo $proses;?></td>
                  <td><?php echo $aktivitas;?></td>
                  <td><?php echo $loading_point;?></td>
                  <td><?php echo $dumping_area;?></td>
                  <td><?php echo $total_ritasi;?></td>
                  <td><?php echo $status;?></td>
                  <td>
                    <a href="<?php echo base_url().'Validator/detail_activity_validator/'.$unit;?>" class="button mr-10" style="font-size:large; text-decoration:none !important;">
