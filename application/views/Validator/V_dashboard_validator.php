            ...
            <div class="col-6 col-md-6 col-sm-12" style="width: 10rem">
              <div class="card card-shadow" id="widgetLineareaTwo">
                <div class="card-block p-20 pt-10">
                  ...
                  <div class="text-center">
                    <a href="<?php echo base_url().'Validator/daily_report';?>" class="btn btn-raised btn-default btn-block waves-effect waves-classic">
                      <h5>Create</h5>
                    </a>
                  </div>
                </div>
            ...
            <div class="col-10 col-md-10 col-sm-12" style="max-width: 80.333333% !important; width: 10rem">
              <div class="card card-shadow" id="widgetLineareaTwo">
                <div class="card-block p-20 pt-10">
                  ...
                  <div class="text-center">
                    <a href="<?php echo base_url().'Validator/hourly_report';?>" class="btn btn-raised btn-default btn-block waves-effect waves-classic">
                      <h5>Create</h5>
                    </a>
                  </div>
                </div>
