      ...
      <div class="panel" style="margin-left: 30px; margin-top: 30px !important;">
        <div class="panel-body">
          <div class="card-block">      
           <form action="<?= base_url('radio/save_breakdown'); ?>" method="POST" class="form-inline">
            <div class="col-lg-6 col-md-12 col-sm-12">
             <div class="row">
              ...
              <div class="col-lg-8 col-md-6 col-sm-12">
                  <input type="hidden" class="form-control" name="no_unit" value="<?= $no_unit; ?>" style="width: 75%;" readonly required>
                  <input type="text" class="form-control" name="nomor_unit" value="<?= $nomor_unit['no_unit'] ?>" style="width: 75%;" readonly required>
              </div>
             </div>
            </div>
            <div class="col-lg-6 col-md-12 col-sm-12">
              <div class="row">
                ...
                <div class="col-lg-8 col-md-6 col-sm-12">
                  <select class="select2" name="type_unit" class="form-control" style="width: 75%" required>
                    <option disabled selected>Pilih</option>
                    <?php
                      foreach ($unit_types as $u) {
                        $selected = '';
                        $readonly = '';
                        if ($u['id'] == $nomor_unit['type_unit']) {
                          $selected = "selected";
                        } else {
                          $readonly = "disabled";
                        }
            ...
            <div class="col-lg-6 col-md-12 col-sm-12">
              <div class="row">
                ...
                <div class="col-lg-8 col-md-6 col-sm-12">
                  <input type="text" class="form-control" name="lokasi" style="width: 75%;" required>
            ...
            <div class="col-lg-6 col-md-12 col-sm-12">
             <div class="row">
              ...
              <div class="col-lg-8 col-md-6 col-sm-12">
                  <input type="time" class="form-control" name="start_bd" id="start_bd" value="" autocomplete="off" style="width: 75%;" required>
              </div>
             </div>
            </div>
            <div class="col-lg-6 col-md-12 col-sm-12">
            ...
            <div class="col-lg-6 col-md-12 col-sm-12">
             <div class="row">
              <div class="col-lg-4 col-md-6 col-sm-12">
               <p style="margin-top: 10px;">RFU Time</p>
              </div>
              <div class="col-lg-8 col-md-6 col-sm-12">
                  <!-- <input type="time" class="form-control" name="" value="05:30"> -->
                  <input type="time" class="form-control" name="rfu" id="rfu" value="" autocomplete="off" style="width: 75%;" required>
              </div>
             </div>
            </div>
            <div class="col-lg-6 col-md-12 col-sm-12">
              <div class="row">
                ...
                <div class="col-lg-8 col-md-6 col-sm-12">
                  <input type="text" class="form-control" name="remark" id="remark" value="" autocomplete="off" style="width: 75%;" required>
                  <!-- <select class="select2" name="remark" class="form-control" style="width: 100%" required>
                    ...
                    <option value="<?= $s['kode']; ?>"><?= $s['kode']; ?></option>
            ...
            <div class="col-lg-6 col-md-12 col-sm-12">
             <div class="row">
              ...
              <div class="col-lg-8 col-md-6 col-sm-12">
                  <!-- <input type="time" class="form-control" name="" value="05:30"> -->
                  <input type="text" class="form-control" name="lokasi_rfu" id="lokasi_rfu" value="" autocomplete="off" style="width: 75%;" required>
              </div>
             </div>
            </div>
            <!-- <div class="col-lg-6 col-md-12 col-sm-12">
            ...
            <div class="col-lg-6 col-md-12 col-sm-12">
             <div class="row">
              ...
              <div class="col-lg-4 col-md-6 col-sm-12">
                <button class="btn btn-success">Save Data Breakdown</button>
              </div>
             </div>
            </div>
            </form>          
            ...
            <table class="table table-hover dataTable table-striped w-full" data-plugin="dataTable">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?= $b['jarak']; ?></td>
                  <td>
                    <a href="<?= base_url('radio/breakdown/edit/'.$b['id']); ?>" class="button mr-10">
                      <i class="icon md-edit"></i>
                    </a>
                    <a href="<?= base_url('radio/breakdown/delete/'.$b['id'].'/add'); ?>" class="button delete-btn">
