    ...
    <div class="page-content container-fluid">
      <div class="row" data-plugin="matchHeight" data-by-row="true">
        <div class="col-xl-12 col-md-12 text-left mb-15">
          ...
          <h4 style="margin-left: 65px;"><b>Dispatcher</b></h4>
        </div>
              ...
              <div class="card card-shadow" id="widgetLineareaTwo">
                <div class="card-block p-20 pt-10">
                  <div class="clearfix">
                    ...
                    <div class="grey-800 py-10 text-center">
                      <h4><b>Hourly Activity</b></h4>
                      <p>Daily Report BODC</p>
                    </div>
                    <span class="float-right grey-700 font-size-30"></span>
                  </div>
                  <div class="text-center">
                    <a href="<?php echo base_url().'Radio/hourly_report';?>" class="btn btn-raised btn-default btn-block waves-effect waves-classic">
                      <h5>Create</h5>
                    </a>
                  </div>
                </div>
              ...
              <div class="card card-shadow" id="widgetLineareaTwo">
                <div class="card-block p-20 pt-10">
                  <div class="clearfix">
                    ...
                    <div class="grey-800 py-10 text-center">
                      <h4><b>Breakdown Information</b></h4>
                      <p>Daily Report BODC</p>
                    </div>
                    <span class="float-right grey-700 font-size-30"></span>
                  </div>
                  <div class="text-center">
                    <a href="<?php echo base_url().'radio/breakdown';?>" class="btn btn-raised btn-default btn-block waves-effect waves-classic">
                      <h5>Create</h5>
                    </a>
                  </div>
                </div>
